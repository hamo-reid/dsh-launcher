...
import { satisfiesRange, parseVersion, compareVersions } from './version.ts'
...
describe('compareVersions', () => {
  ...
  it('treats unparseable versions as less than parseable ones', () => {
    expect(compareVersions('1.2.3-beta', '1.2.4')).toBe(-1)
    expect(compareVersions('1.2.4', '1.3.0-dev')).toBe(1)
