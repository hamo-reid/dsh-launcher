...
import { archiveFile, flushToDisk, pruneArchives, snapshotBackup } from './file.ts'
import type { AppSettings, DshSettings, LaunchSettings, PrefsSettings } from './normalize.ts'

// Kept on this module's public surface so importers of `./settings.ts` are unchanged.
export { CURRENT_SCHEMA_VERSION, normalizeSettings } from './normalize.ts'
export type { AppSettings } from './normalize.ts'
