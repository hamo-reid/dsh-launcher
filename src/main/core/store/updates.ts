...
import { buildInstalledOverview } from './overview.ts'
import { readPluginSourceSpec } from './sources.ts'
import { compareVersionsLoose } from '../shared/version.ts'
...
import type { DshScope } from '../profile/appState.ts'
