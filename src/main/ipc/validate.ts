/**
 * IPC argument validation. The path/version guards live in `core/profile/name-guard.ts`
 ...
 */
export { pathIdentifierInvalid, pathOutsideRoot, versionInvalid } from '../core/profile/name-guard.ts'
