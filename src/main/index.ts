...
import { listRuns, registerRunIpc, stopAllRuns, subscribeRunState } from './ipc/dsh/run.ts'
import { formatRunDuration } from './core/shared/run-registry.ts'
import type { RunInfo } from '../shared/types.ts'
import { registerProfileIpc } from './ipc/profile/profile.ts'
import { registerHomeIpc } from './ipc/profile/home.ts'
import { registerPluginsIpc } from './ipc/plugins/plugins.ts'
import { registerDshIpc } from './ipc/dsh/dsh.ts'
import { registerHomeDataIpc } from './ipc/profile/home-data.ts'
...
import { registerLogsIpc } from './ipc/app/logs.ts'
import { child, initLogger, logger, printBanner } from './core/shared/logger.ts'
import {
  askOnCloseEnabled, closeToTrayEnabled, flushSettings, openDatabase, patchSettings,
} from './core/settings/settings.ts'
import { configureAppState, pluginDir } from './core/profile/appState.ts'
import { migrateLaunchConfigKeys } from './core/profile/launch-config.ts'
import { configurePnpmStore } from './core/dsh/pnpm.ts'
